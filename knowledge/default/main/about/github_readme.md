...
[![Join our Skool Community](https://img.shields.io/badge/Skool-Join%20our%20Community-4A90E2?style=for-the-badge&logo=skool&logoColor=white)](https://www.skool.com/syno-ai) [![Join our Discord](https://img.shields.io/badge/Discord-Join%20our%20server-5865F2?style=for-the-badge&logo=discord&logoColor=white)](https://discord.gg/B8KZKNsPpj) [![Subscribe on YouTube](https://img.shields.io/badge/YouTube-Subscribe-red?style=for-the-badge&logo=youtube&logoColor=white)](https://www.youtube.com/@SynoAIFW) [![Connect on LinkedIn](https://img.shields.io/badge/LinkedIn-Connect-blue?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/jan-tomasek/) [![Follow on X.com](https://img.shields.io/badge/X.com-Follow-1DA1F2?style=for-the-badge&logo=x&logoColor=white)](https://x.com/JanTomasekDev)


[![Intro Video](/docs/res/new_vid.jpg)](https://www.youtube.com/watch?v=U_Gl0NPalKA)

**Personal and organic AI framework**
- Syno AI is not a predefined agentic framework. It is designed to be dynamic, organically growing, and learning as you use it.
- Syno AI is fully transparent, readable, comprehensible, customizable and interactive.
- Syno AI uses the computer as a tool to accomplish its (your) tasks.
...
- Syno AI is not pre-programmed for specific tasks (but can be). It is meant to be a general-purpose personal assistant. Give it a task, and it will gather information, execute commands and code, cooperate with other agent instances, and do its best to accomplish it.
- It has a persistent memory, allowing it to memorize previous solutions, code, facts, instructions, etc., to solve tasks faster and more reliably in the future.

2. **Computer as a tool**
- Syno AI uses the operating system as a tool to accomplish its tasks. It has no single-purpose tools pre-programmed. Instead, it can write its own code and use the terminal to create and use its own tools as needed.
- The only default tools in its arsenal are online search, memory features, communication (with the user and other agents), and code/terminal execution. Everything else is created by the agent itself or can be extended by the user.
- Tool usage functionality has been developed from scratch to be the most compatible and reliable, even with very small models.

* **Default Tools:** Syno AI includes tools like knowledge, webpage content, code execution, and communication. 
* **Creating Custom Tools:**  Extend Syno AI's functionality by creating your own custom tools.
* **Instruments:**  Instruments are a new type of tool that allow you to create custom functions and procedures that can be called by Syno AI.
...
![Syno AI](/docs/res/splash_wide.png)
...
With proper instruction, Syno AI is capable of many things, even potentially dangerous to your computer, data, or accounts. Always run Syno AI in an isolated environment (like the one provided with Docker) and be careful what you wish for.

2. **Syno AI is not pre-programmed; it is prompt-based.**
...
Syno AI is made to be used in an isolated virtual environment (for safety) with some tools preinstalled and configured.
...
## Ideal environment
- **Docker container**: The perfect environment to run Syno AI is the built-in Docker container. The agent can download the image **synotechai/syno-ai-exe** on its own and start the container, you only need to have Docker running (like the Docker Desktop application).
...
## Setup
A detailed setup guide for Windows, macOS and Linux with a video can be found in the new Syno AI Documentation at [this page](docs/installation.md#windows-macos-and-linux-setup-guide). 

You can download the executable for your system from the [releases page](https://github.com/synotechai/syno-ai/releases).

## Consult the Documentation
The documentation dives deep into the framework and its features. It is a good place to start if you are new to Syno AI. Click [here](docs/README.md) to see the Documentation.
...
> [!NOTE]  
> **Changes to synotechai/syno-ai Docker image since v0.8:**  
> - In version 0.8, the Docker image has changed to synotechai/syno-ai-run using the new Dockerfile.
...
> - the Docker image has been changed to synotechai/syno-ai-run from the legacy installation process.