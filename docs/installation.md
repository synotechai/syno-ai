...
> socket to be used (requires password)."  This allows Syno AI to communicate 
...
> Docker socket to be used (requires password)."  This allows Syno AI to 
...
> are run. If you want to run Syno AI on another machine, you will need to run 
