...
-   Join the Syno AI [Discord](https://discord.gg/FvgkyNCk9P) community for support and discussions.
...
* **Performance Issues:** If Syno AI is slow or unresponsive, it might be due to resource limitations, network latency, or the complexity of your prompts and tasks, especially when using local models.
