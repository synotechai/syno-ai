# How to install Syno AI on Windows and MacOS
...
- I will provide step by step instructions along with a video for this tutorial on how to make Syno AI work on Windows and MacOS.
...
2. You don't need API keys, Syno AI can run with local models, but for this tutorial I will leave it to the default OpenAI API. Local models will be covered in another tutorial.
3. You don't need Visual Studio Code or any other code editor, but it's easier to navigate and edit files if you have one.
4. Docker is not mandatory, but running Syno AI without docker is actually more complicated and can be very dangerous, so I will be showing the easier and recommended way to do it - with Docker Desktop application.
...
<img src="image-14.png" alt="syno ai download" width="500"/>
<br><br>
...
<img src="image-15.png" alt="syno ai cd" height="100"/>
<img src="image-16.png" alt="syno ai cd" height="100"/>
<br><br>
