...
## Ideal environment
- **Linux VM**: The perfect environment to run Syno AI is a Debian-based Linux virtual machine with enhanced privileges or root access (to install packages and run terminal commands).
