...
A detailed setup guide with a video can be found here: [/docs/installation](https://github.com/synotechai/syno-ai/tree/main/docs/installation). Scroll down to see the readme file.
