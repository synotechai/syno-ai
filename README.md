...
Syno AI is made to be used in an isolated virtual machine (for safety) with some tools preinstalled and configured.
...
## Ideal environment
- **Linux VM / docker container**: The perfect environment to run Syno AI is a Debian-based Linux virtual machine or docker container with enhanced privileges or root access (to install packages and run terminal commands).
